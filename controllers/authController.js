...
const { attachCookiesToResponse, createTokenUser, isTokenValid, sendVerificationEmail, sendResetPasswordEmail, createHash } = require('../utils');
...
const register = async (req, res) => {
  ...
  res.status(StatusCodes.CREATED).json({msg: 'Success! Pleas check your email'})
};
